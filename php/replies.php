...
function getRepliesData($user){
    ...
    $query_id = "SELECT c.id_conv FROM users u join messages m on u.id_user=m.id_user join conv c on m.id_conv=c.id_conv join users u1 on u1.id_user=m.id_sender where u.id_user = '{$user}'";
    ...
    $data_push_id = array(); $data_push_to = array(); $data_push_ti = array(); $data_push_na = array(); $data_push_su = array();
    $json_array = array();
