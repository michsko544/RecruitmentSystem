    ...
    if(decision==="Rejected"){
        ...
        newDiv = document.createRange().createContextualFragment(
            `<div class="list-row">
                <div class="change-btn" id="${aid}"></div>
                <div class="position first-text-after-btn">${position}</div>
                <div class="app-info last-text-after-btn">${name} - <span class="dark-color">Accepted</span></div>
                <a href="profileW.php?uid=${id}&aid=${aid}" class="btn-element rotate-to-right" >
                    <div class="btn-unwrap">
                        <div class="line1"></div>
                        <div class="line2"></div>
        ...
        newDiv = document.createRange().createContextualFragment(
            `<div class="list-row">
                <div class="change-btn" id="${aid}"></div>
                <div class="position first-text-after-btn">${position}</div>
                <div class="app-info last-text-after-btn">${name} - <span style="opacity:0.65;">New</span></div>
                <a href="profileW.php?uid=${id}&aid=${aid}" class="btn-element rotate-to-right" >
                    <div class="btn-unwrap">
                        <div class="line1"></div>
                        <div class="line2"></div>
